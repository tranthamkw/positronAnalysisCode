...
3. python3 processfiles.py <subdir>
	...
	opens GSPEC files and adds to a histogram indexed by wheel location. we get a summed list of all spectra for each wheel location. ALSO sums livetime for each sample location.

TODO:
3. python3 masterRegionalSums.py

4. python3 masterSumHistograms.py
